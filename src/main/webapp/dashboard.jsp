                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="card-text">${usuario.roles.size()} asignados</p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="card-text">Autenticación UMariana</p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <c:forEach var="rol" items="${usuario.roles}">
                                                <span class="badge bg-primary me-1">${rol.rol}</span>
                                            </c:forEach>
                                        </div>
                                    </div>
                                </div>
