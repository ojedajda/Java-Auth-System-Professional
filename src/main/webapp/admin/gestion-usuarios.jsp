            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                            ...
                            <div class="card text-white bg-primary">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4 class="card-title">${usuarios.size()}</h4>
                        ...
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <c:forEach var="usuario" items="${usuarios}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../admin/gestionRoles?idUsuario=${usuario.idUsuario}" 
                            ...
                            <c:if test="${empty usuarios}">
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">Los usuarios aparecerán aquí una vez se registren en el sistema.</p>
                                </div>
                            </c:if>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info mt-4">
                        <h6><i class="fas fa-info-circle me-2"></i>Permisos de Administrador</h6>
                        <p class="mb-0">
                            Como administrador, puedes ver todos los usuarios del sistema, gestionar sus roles 
